...
import org.firstinspires.ftc.teamcode.autonomous.pedro.Constants
...
class Robot(
    ...
    override fun followPathCMD(path: Path, holdEnd: Boolean): Command {
        return drive.followPathCMD(path, holdEnd)
    }
}